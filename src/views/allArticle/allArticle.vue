          ...
          <div class="menu-top-menu-container">
            ...
            <ul id="menu-top-menu" class="clearfix">
              <el-menu :default-active="activeIndex" background-color=rgba(0,0,0,0)  class="el-menu-demo" mode="horizontal" @select="handleSelect">
                <el-menu-item index="1" ><a href="/menu">网站主页</a></el-menu-item>
                <el-menu-item index="3" class="import"><a href="/allArticle">所有文章</a></el-menu-item>
...
<!--      <el-radio-group v-model="radio1">-->
        <el-button  @click="toAllType" class="choice">All</el-button>
